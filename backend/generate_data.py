"""
generate_data.py — Synthetic MPLADS Dataset Generator for Mantri Drishti V1.

Creates ~80 projects across 6 states with deliberately planted anomalies:
  - High expenditure + low progress (financial mismatch)
  - Large timeline-progress gaps
  - Overdue / delayed projects
  - Potential overlapping pairs (same area, similar work, close amounts)
  - Entity clusters (same contractor with multiple flagged projects)
  - Normal / healthy projects (majority)

Output: data/sample_projects.csv

IMPORTANT: This is SYNTHETIC DEMONSTRATION DATA.
           It must never be presented as real government data.
"""
