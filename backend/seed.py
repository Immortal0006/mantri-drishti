"""
seed.py — One-shot script to generate the database from the CSV.

Usage:
    python seed.py

Steps:
    1. Creates all tables in SQLite
    2. Loads CSV → cleans → computes fingerprint → inserts into DB
    3. Runs all intelligence engines (if available)
    4. Prints summary
"""
