"""
dossier.py — Engine 4: Peer Benchmarking + Dossier Generation.

Peer Benchmarking:
  Never ask "Is ₹50 lakh expensive?"
  Ask "Is this project unusual COMPARED WITH SIMILAR PROJECTS?"

Peers are selected by:
  - Same / similar work type
  - Similar sanctioned scale (within 2x)
  - Same state where appropriate

Compare: expenditure_ratio, progress_gap, delay_days
Against: Median, IQR
"""
