"""
similarity.py — Engine 3: Similarity / Duplicate Detection.

Detects potentially similar, duplicate, or overlapping projects using
multiple aligned signals:
  - TF-IDF + Cosine Similarity (text)
  - Haversine distance (geography)
  - Sanctioned amount closeness
  - Overlapping execution windows
  - Same work type
  - Same agency / contractor
"""
