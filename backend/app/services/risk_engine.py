"""
risk_engine.py — Orchestrates all intelligence engines and produces fused risk.

This is the central coordinator:
  1. Runs Rule Engine
  2. Runs Isolation Forest
  3. Runs Similarity Analysis
  4. Runs Peer Benchmarking
  5. Fuses scores into final Risk + Confidence
  6. Generates "Why Flagged"
  7. Persists RiskAssessment records
"""
