"""
anomaly_detection.py — Rule Engine + Isolation Forest.

Engine 1 — Rule Engine:
  Deterministic, transparent, auditable rules.
  Returns a score (0–100) and list of human-readable reasons.

Engine 2 — Isolation Forest:
  Unsupervised anomaly detection on numerical fingerprint features.
  Returns a score (0–100) and anomaly flag.
"""
