"""
SQLAlchemy ORM models for Mantri Drishti.

Two tables:
  - Project: stores raw + computed fingerprint fields from the CSV
  - RiskAssessment: stores risk engine outputs per project
"""
