  ...
  const layout = useMemo(
    () => ({
      title: {
        ...
        font: { size: 14, color: '#e2e8f0', family: 'Inter, system-ui, sans-serif' },
        x: 0.5,
      },
      ...
      annotations: [
        {
          ...
          showarrow: false,
          font: { size: 22, color: '#e2e8f0', family: 'JetBrains Mono, monospace' },
          x: 0.5,
          y: 0.5,
        },
      ],
    ...
    () => [
      {
        ...
        textfont: { size: 10, color: '#0f172a', family: 'JetBrains Mono, monospace' },
